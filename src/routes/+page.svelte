<script lang="ts">
	...
	import { addNewWifi } from '$lib/stores/wifiList';
	import Heading from '$lib/components/Typography/Heading.svelte';
	import TextInput from '$lib/components/Input/TextInput.svelte';
	import RadioGroup from '$lib/components/Input/RadioGroupInput.svelte';
...
<Heading heading="Create" subHeading="Your wifi information stays in your machine and did not send to any server." />
...
<div class="">
	<form on:submit|preventDefault={handleFormSubmit} class="space-y-4">
		...
		<div class="flex items-center gap-2 pl-4">
			<button type="submit" class="bg-blue-600 hover:opacity-80 active:opacity-90 px-6 py-2 transition-all"
				>Create</button
			>
			{#if qrSrc}
				<button
